...
- Once you get a GOhm seal you can break into the cell. You can do this by creating a sudden, brief negative pressure. If you want to you can simultaneously hit the zap button if your amplifier has it. I use a 50 us zap. The zap outputs a strong current from your electrode that can help dissolve the membrane and reduce your access resistance.
